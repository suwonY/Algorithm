...
import java.util.*;
public class swExpert_2382_fix2 {
				...
				for(int i=0; i<n; i++){
					for(int j=0; j<n; j++){
						...
						if(b[1][nx][ny]!=null && cnt!=0){
							...
							List<Temp> temp = next.arr;
							temp.add(new Temp(cnt,dir));
							...
							Point tt = new Point(nx,ny,dir,total);
							tt.addList(temp);
							b[1][nx][ny] = tt;
//							print();
							continue;
...
//							print();
	...
	public static class Point{
		...
		public void addList(List<Temp> t){
			for(Temp temp : t){
				arr.add(temp);
			}
		}
		public void replaceArr(){
			arr = new ArrayList<>();
		}
	}
