...
id_2345 = pd.DataFrame(pd.concat((date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
id_2345['a'] = 1

id_1 = pd.DataFrame(date_rating_train1['ID'])
id_1['a'] = 1
...
peoplerating_1.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/peoplerating_1.csv', index=False)

#---------------------------------------------------------------------------------------------------------------

#train2 X train1345 인구통계학적 유사도
id_1345 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train3['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
id_1345['a'] = 1

id_2 = pd.DataFrame(date_rating_train2['ID'])
id_2['a'] = 1
...
peoplerating_2.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/peoplerating_2.csv', index=False)

#---------------------------------------------------------------------------------------------------------------

#train3 X train1245 인구통계학적 유사도
id_1245 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
id_1245['a'] = 1

id_3 = pd.DataFrame(date_rating_train3['ID'])
id_3['a'] = 1
...
peoplerating_3.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/peoplerating_3.csv', index=False)

#---------------------------------------------------------------------------------------------------------------

#train4 X train1235 인구통계학적 유사도
id_1235 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train5['ID'])))
id_1235['a'] = 1

id_4 = pd.DataFrame(date_rating_train4['ID'])
id_4['a'] = 1
...
peoplerating_4.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/peoplerating_4.csv', index=False)

#---------------------------------------------------------------------------------------------------------------

#train5 X train1234 인구통계학적 유사도
id_1234 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train4['ID'])))
id_1234['a'] = 1

id_5 = pd.DataFrame(date_rating_train5['ID'])
id_5['a'] = 1
...
peoplerating_5.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/peoplerating_5.csv', index=False)