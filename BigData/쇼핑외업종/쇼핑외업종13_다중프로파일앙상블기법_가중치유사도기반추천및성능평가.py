...
for z in range(1,6):
    ...
    id_train1_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_else_train' + str(z)+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train2_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_else_train'+ str(ilist[0])+'.csv' , sep=',', dtype={'ID':str} ,engine='python')
    id_train3_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_else_train' + str(ilist[1])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train4_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_else_train'+ str(ilist[2])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train5_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_else_train'+ str(ilist[3])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    simil= pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/elseweight_rating_' + str(z)+'.csv' , sep=',', engine='python',
                                       dtype= {'ID' : str})
    ...
    eval.append(np.sum(lift_ratio)/2000)    
