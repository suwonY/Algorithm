...
id_test_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_test.csv', sep=',', dtype={'ID':str} ,engine='python')
simil= pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/test_weight_rating.csv' , sep=',', engine='python',
                                   dtype= {'ID' : str})
...
P_u1_current=P_u1_current.sort_values(by='ID',axis=0)
P_u4_current=P_u4_current.sort_values(by='ID',axis=0)
...
item_score = pd.merge(Pu1idx,item_score, how='inner' , on='ID')
...
eval.append(np.sum(lift_ratio)/1829)    
