...
for z in range(1,6):
    ...
    id_train1_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_train' + str(z)+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train2_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_train'+ str(ilist[0])+'.csv' , sep=',', dtype={'ID':str} ,engine='python')
    id_train3_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_train' + str(ilist[1])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train4_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_train'+ str(ilist[2])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    id_train5_current = pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/date_rating_train'+ str(ilist[3])+'.csv', sep=',', dtype={'ID':str} ,engine='python')
    simil= pd.read_csv('C:/Users/조만재/Desktop/lpoint/lpoint/habit_train' + str(z)+'.csv' , sep=',', engine='python',
                                       dtype= {'ID' : str})
                                       dtype= {'ID' : str})
    del simil['Unnamed: 0']
    s = []
    for i in range(0, len(simil)):
        idx = simil['ID'].iloc[i]
        idx = '%05d' % (int(idx))
        str(idx)
        s.append(idx)
    ...
    col_habit = list(simil.columns)
    col_habit2 = []
    for i in col_habit:
        col_habit2.append(i.zfill(5))
    simil.columns = col_habit2
    simil['ID'] = id_habit
