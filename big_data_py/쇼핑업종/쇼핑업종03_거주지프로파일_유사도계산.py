...
rating_1234 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train4['ID'])))
rating_1234 = pd.merge(rating_1234, demo1,how='inner' , on='ID')
rating_1234.index = rating_1234['ID']
del rating_1234['ID']

rating_1235 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train5['ID'])))
rating_1235 =pd.merge(rating_1235, demo1,how='inner' , on='ID')
rating_1235.index = rating_1235['ID']
del rating_1235['ID']

rating_1245 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train2['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
rating_1245 =pd.merge(rating_1245, demo1,how='inner' , on='ID')
rating_1245.index = rating_1245['ID']
del rating_1245['ID']

rating_1345 = pd.DataFrame(pd.concat((date_rating_train1['ID'],date_rating_train3['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
rating_1345 =pd.merge(rating_1345, demo1,how='inner' , on='ID')
rating_1345.index = rating_1345['ID']
del rating_1345['ID']

rating_2345 = pd.DataFrame(pd.concat((date_rating_train2['ID'],date_rating_train3['ID'],date_rating_train4['ID'],date_rating_train5['ID'])))
rating_2345 =pd.merge(rating_2345, demo1,how='inner' , on='ID')
rating_2345.index = rating_2345['ID']
del rating_2345['ID']

rating_1 = pd.merge(pd.DataFrame(date_rating_train1['ID']),demo1,how='inner' , on ='ID')
rating_1.index = rating_1['ID']
del rating_1['ID']

rating_2 = pd.merge(pd.DataFrame(date_rating_train2['ID']),demo1,how='inner' , on ='ID')
rating_2.index = rating_2['ID']
del rating_2['ID']

rating_3 = pd.merge(pd.DataFrame(date_rating_train3['ID']),demo1,how='inner' , on ='ID')
rating_3.index = rating_3['ID']
del rating_3['ID']

rating_4 = pd.merge(pd.DataFrame(date_rating_train4['ID']),demo1,how='inner' , on ='ID')
rating_4.index = rating_4['ID']
del rating_4['ID']

rating_5 = pd.merge(pd.DataFrame(date_rating_train5['ID']),demo1,how='inner' , on ='ID')
...
tanimotorating1.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/tanimoto_rating1.csv' ,index=False)
...
tanimotorating2.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/tanimoto_rating2.csv',index=False )
...
tanimotorating3.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/tanimoto_rating3.csv',index=False )
...
tanimotorating4.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/tanimoto_rating4.csv',index=False )
...
tanimotorating5.to_csv('C:/Users/조만재/Desktop/lpoint/lpoint/tanimoto_rating5.csv',index=False )
